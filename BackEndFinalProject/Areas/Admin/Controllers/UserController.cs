using BackEndFinalProject.Areas.Admin.ViewComponents;
using BackEndFinalProject.Areas.Admin.ViewModels.Plant;
using BackEndFinalProject.Areas.Admin.ViewModels.Role;
using BackEndFinalProject.Areas.Admin.ViewModels.User;
using BackEndFinalProject.Database;
using BackEndFinalProject.Database.Models;
using BackEndFinalProject.Migrations;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;
using System.Net;
using Basket = BackEndFinalProject.Database.Models.Basket;
using User = BackEndFinalProject.Database.Models.User;
