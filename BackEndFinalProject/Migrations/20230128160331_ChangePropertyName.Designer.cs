...
namespace BackEndFinalProject.Migrations
{
    ...
    [Migration("20230128160331_ChangePropertyName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEndFinalProject.Database.Models.BlogImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEndFinalProject.Database.Models.BlogAndBlogTag", b =>
                {
                    b.HasOne("BackEndFinalProject.Database.Models.Blog", "Plant")
                        .WithMany("BlogTags")
                        .HasForeignKey("BlogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
